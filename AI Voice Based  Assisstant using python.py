...
    server.ehlo()
    server.starttls()
    server.login('radha22990@gmail.com', 'radha@2001')
...
                speak("what should I send sir?")
                content = takeCommand().lower()
                to = "ajaysrirambab@gmail.com@gmail.com"
                sendEmail(to,content)
                speak('Email has been sent sir') 
...
            speak("I have been created by Radha.") 
...
            speak("Thanks to Radha. further It's a secret") 

        elif 'is love' in query:
            speak("It is 7th sense that destroy all other senses") 

        elif "who are you" in query:
            speak("I am your virtual assistant created by Radha") 

        elif 'reason for creating you' in query:
            speak("I was created as a Minor project by Mister Radha ") 
